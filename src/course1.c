...
#include "course1.h" //test func declarations
#include "platform.h" //PRINTF
#include "memory.h" //memory func
#include "data.h" //data manipulation func
#include "stats.h" //print array func
...
int8_t test_data1() {
  ...
  PRINTF("\ntest_data1();\n");
  ptr = (uint8_t*) reserve_words( DATA_SET_SIZE_W );//what is uint8_t*, think?
  ...
  #endif
  free_words(ptr); //this should be uint8_t*???
